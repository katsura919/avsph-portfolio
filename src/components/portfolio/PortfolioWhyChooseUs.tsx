    ...
    <section id="why-choose-us" className="section bg-[var(--primary)]">
      <div className="container">
        <div className="mb-12 text-center">
          <span className="mb-3 block font-bold uppercase tracking-wider text-[var(--accent-light)]">
            Why Choose Us
          </span>
          ...
          <p className="mx-auto max-w-3xl text-lg text-white/80">
            AVSPH combines the right people, clear systems, and ongoing support
